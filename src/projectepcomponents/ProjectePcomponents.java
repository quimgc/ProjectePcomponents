...
public class ProjectePcomponents {
    ...
    public static void introduirComponent() {
    ...
    public static void modificarComponent() {
        Scanner entrada = new Scanner(System.in);
        Scanner entNum = new Scanner(System.in);
        char respostaobsolet;
        char resposta = 'N';
        ...
        if (resposta == 'S') {
            ...
            System.out.println("No hi ha productes per modifciar!!");
        }

    }

    public static void mostrarComponent() {
        int i = 0;
    ...
    public static void esborrarProducte() {
    ...
    public static void recuperarProducte() {
        int cont = 0;
        Scanner entrada = new Scanner(System.in);
        Scanner entNum = new Scanner(System.in);
        ...
        if (resposta == 'S') {
            ...
            System.out.println("No hi ha components per recuperar.");
        } else {
            System.out.println("Component no recuperat.");
        }
    }
